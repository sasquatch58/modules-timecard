...
$.widget('ui.spinner', {
	...
	_format: function(num) {
		...
		if (this.options.format) {
			this.element.val(this.options.format(num));
		}
		else {
			var culture = $.culture || $.cultures['default'];
			this.element.val( $.format && this.options.numberformat ? $.format(num, this.options.numberformat, culture).replace(culture.numberFormat.currency.symbol, "") : num );
		}
	},
